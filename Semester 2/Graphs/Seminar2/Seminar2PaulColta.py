...
Parse outbound: 0.1709427813557129
Parse inbound: 0.13453388213111328

n = 10000, m = n * 10

Parse outbound: 13.399217332763672
Parse inbound: 14.270213273025513
...
Parse outbound: 0.0
Parse inbound: 0.304112046585083
...
Parse outbound: 0.12343034207519531
Parse inbound: Too long > 5 min

n = 1000000, m = n * 10

Parse outbound: 1.69517199303833
Parse inbound: Too long > 5 min
...
Parse outbound: 0.012972997665405273
Parse inbound: 0.012344993439941406

n = 100000, m = n * 10

Parse outbound: 0.16308119061584473
Parse inbound: 0.15540142227697754

n = 1000000, m = n * 10

Parse outbound: 1.6387911453125
Parse inbound: 1.5638901139904785
